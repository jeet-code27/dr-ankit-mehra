...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/images/before-after-portrait-woman-retouched-scaled.jpg", // replace with actual image path
        width: 2560,
        height: 1707,
  ...
  twitter: {
    ...
    description:
      "Minimize scars and restore smooth skin with advanced scar reduction therapies. Proven techniques for acne scars, injury scars, and more.",
    images: ["/images/before-after-portrait-woman-retouched-scaled.jpg"], // replace with actual image path
  },
  robots: {
    index: true,
    follow: true,
...
const ScarReduction = () => {
  ...
  const skinInfo = {
    ...
    description: "Scar reduction treatments can minimize scars from acne, injuries, or surgery. Methods include microneedling, laser therapy, and dermal fillers.",
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="relative h-96 md:h-[500px] overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
              ...
              <p className="text-lg md:text-xl opacity-90">Advanced Scar Reduction Treatments</p>
            </div>
          </div>
        ...
        <div className="mt-8 bg-white rounded-xl p-6 shadow-md">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="mb-4 md:mb-0">
              <h3 className="text-xl font-bold text-gray-800 mb-2">Professional Scar Reduction Treatments</h3>
