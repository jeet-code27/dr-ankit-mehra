...
const PRPTherapy = () =>
{
  const skinInfo = {
    ...
    details: [
      {
        category: "Symptoms",
        items: ["Thinning hair", "Hair loss", "Receding hairline"],
      },
      {
        category: "Causes",
        items: ["Genetics", "Hormonal changes", "Stress", "Medical conditions"],
      },
      {
        category: "Risks",
        items: [
    ...
    benefits: [
      ...
      "Uses body’s own healing properties",
          ...
          <div className="relative h-96 md:h-[500px] overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
              ...
              <p className="text-lg md:text-xl opacity-90">
                Advanced Hair Restoration Therapy
              </p>
            </div>
          </div>
