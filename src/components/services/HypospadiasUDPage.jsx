          ...
          >
            <motion.div variants={fadeIn} className="mb-4 md:mb-6">
              <span className="inline-flex items-center px-3 py-1 md:px-4 md:py-2 rounded-full bg-blue-600 text-white text-sm md:text-base font-medium">
                <Baby className="mr-1 md:mr-2" size={14} />
            ...
            >
              Expert correction for congenital urinary tract abnormalities
            </motion.p>
    ...
    <button className="bg-blue-500 hover:bg-blue-400 cursor-pointer font-bold px-6 py-3 md:px-8 md:py-4 rounded-lg transition-all flex items-center justify-center text-base md:text-lg">
      ...
      <div className="bg-blue-50 py-12 md:py-20 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-2xl md:text-4xl font-bold text-blue-900 mb-3 md:mb-4">Congenital Urological Correction</h2>
          ...
          >
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 md:p-8 text-center">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-blue-900 mb-3 md:mb-4">Pediatric Experts</h3>
              <p className="text-sm md:text-base text-gray-600">
          ...
          >
            <div className="lg:w-1/2">
              <div className="relative w-full h-64 md:h-96 rounded-xl overflow-hidden shadow-lg">
                <Image 
                  src="/images/diseases/hypospadias.jpg" 
                  alt="Hypospadias and UDT Treatment"
                  fill
            ...
            <div className="lg:w-1/2">
              <h2 className="text-2xl md:text-3xl font-bold text-blue-900 mb-4 md:mb-6">Understanding Hypospadias & UDT</h2>
      ...
      <div className="bg-gradient-to-br from-blue-900 via-blue-800 to-teal-600 text-white py-12 md:py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            className="text-center mb-12 md:mb-16"
          >
            <h2 className="text-2xl md:text-4xl font-bold mb-4 md:mb-6">Why Choose Our Pediatric Urology Care?</h2>
              ...
              {[
                {
                  ...
                  description: "Physical exam, ultrasound, and hormonal assessment",
                  icon: <Stethoscope size={18} />
                },
                {
                  title: "Preoperative Planning",
                  description: "Surgical approach selection and family counseling",
                  icon: <CheckCircle size={18} />
                },
                {
                  title: "Surgical Correction",
                  description: "Precise reconstruction under magnification",
                  icon: <Scale size={18} />
                },
                {
                  title: "Postoperative Care",
                  description: "Dressing management and pain control",
                  icon: <HeartPulse size={18} />
                },
                {
                  title: "Recovery Monitoring",
                  description: "Follow-up to ensure proper healing and function",
      ...
      <div className="py-12 md:py-20 bg-white px-4">
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            className="text-center mb-12 md:mb-16"
          >
            <h2 className="text-2xl md:text-4xl font-bold text-blue-900 mb-4 md:mb-6">Parent Experiences</h2>
          </motion.div>
          ...
          >
            {[
              {
                name: "Priya M.",
                age: "Mother of 2-year-old",
                quote: "The hypospadias repair gave my son a completely normal appearance."
              },
              {
                name: "Rahul K.",
                age: "Father of 5-year-old",
                quote: "UDT surgery was quick and my son recovered faster than we expected."
              },
              {
                name: "Anjali S.",
                age: "Mother of 3-year-old",
                quote: "The team's expertise with complex hypospadias made all the difference."
              }
            ].map((patient, index) => (
              <div key={index} className="bg-gray-50 rounded-xl p-6 md:p-8 shadow-md">
                ...
                <div className="text-center">
                  ...
                  <p className="text-xs md:text-sm text-gray-500">{patient.age}</p>
                </div>
              </div>
            ))}
          </motion.div>
      ...
      <div className="py-12 md:py-20 bg-gray-50 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          >
            {[
              {
                question: "What causes hypospadias and UDT?",
                answer: "These are congenital conditions likely caused by hormonal and genetic factors during fetal development. Most cases occur sporadically."
              },
              {
                question: "When should these conditions be treated?",
                answer: "Hypospadias repair is typically done at 6-18 months. UDT correction is ideally performed by 12-18 months to preserve fertility."
              },
              {
                question: "What's the recovery like after surgery?",
                answer: "Most children recover quickly, with 1-2 weeks of reduced activity. Stents or catheters are usually removed within 7-10 days."
              },
              {
                question: "Will my child need future surgeries?",
                answer: "Most single-stage repairs are successful long-term. Complex cases may require additional procedures during childhood."
              }
            ].map((faq, index) => (
...
export default HypospadiasUDPage;