...
const LaserTattooRemoval = () =>
{
  const skinInfo = {
    ...
    details: [
      {
        category: "Symptoms",
        items: ["Unwanted tattoo visibility"],
      },
      {
        category: "Causes",
        items: ["Old tattoos that are no longer wanted", "Unprofessional tattoos"],
      },
      {
        category: "Risks",
        items: [
    ...
    benefits: [
      "Safe and effective removal of unwanted tattoos",
      "Works on all tattoo colors and sizes",
      "Minimal risk of scarring compared to traditional methods",
      "Quick recovery and minimal downtime",
      "Precise targeting of tattoo pigments without harming surrounding skin",
      "Boosts confidence by restoring natural skin appearance",
    ],
  };
          ...
          <div className="relative h-96 md:h-[500px] overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
              ...
              <p className="text-lg md:text-xl opacity-90">
                Advanced Tattoo Removal Solutions
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="mb-4 md:mb-0">
              ...
              <p className="text-gray-600">
                All procedures performed by certified specialist
              </p>
            </div>
