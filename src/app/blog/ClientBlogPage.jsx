      ...
      <div className="max-w-7xl mx-auto">
            ...
            <div className="md:flex justify-between items-center">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <div className="flex items-center">
                  ...
                  <span>Kshetrapal Hospital, Ajmer</span>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        <div className="mt-20 bg-white rounded-2xl shadow-xl overflow-hidden">
          <div className="md:flex">
            ...
            >
              <h3 className="text-2xl font-bold mb-4">About Dr. Vishnu Agrawal</h3>
              <p className="mb-6">One of the best urologists in Ajmer with expertise in laparoscopic surgery and comprehensive urological care.</p>
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900">Laparoscopic Surgery</h4>
                      <p className="text-gray-600">Minimally invasive surgical techniques for urological conditions</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900">Kidney Surgery</h4>
                      <p className="text-gray-600">Expert in kidney stone treatment and renal surgeries</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <div className="bg-blue-100 p-3 rounded-lg mr-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Specialized care for male reproductive and urinary health</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <div className="bg-teal-100 p-3 rounded-lg mr-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900">Uro-Oncology</h4>
                      <p className="text-gray-600">Diagnosis and treatment of urological cancers</p>
                    </div>
                  </div>
                </div>
              </motion.div>
