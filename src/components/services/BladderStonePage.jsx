...
const BladderStonePage = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative h-[400px] md:h-[500px]">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white p-4">
          ...
          >
            ...
            >
              Safe and effective removal of stones formed in the urinary bladder
            </motion.p>
          </motion.div>
        </div>
      </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <div className="lg:w-1/2">
              <img 
                src="/images/diseases/bladder-stones.png" 
                alt="Bladder Stone Anatomy" 
                className="rounded-xl shadow-lg w-full"
              />
            </div>
            
            <div className="lg:w-1/2">
              <h2 className="text-2xl md:text-3xl font-bold text-blue-900 mb-4 md:mb-6">About Bladder Stones</h2>
              <h3 className="text-xl md:text-2xl font-bold text-blue-800 mb-4 md:mb-6">मूत्राशय पथरी के बारे में</h3>
              
              <p className="text-base md:text-lg text-gray-700 mb-4 md:mb-6">
                Bladder stones are hard mineral deposits that form in the bladder when urine becomes concentrated. They can cause discomfort, urinary infections, and difficulty urinating.
              </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-base md:text-xl text-gray-700 max-w-3xl mx-auto">
              Modern techniques for bladder stone removal
            </p>
          </motion.div>
          ...
          >
            <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl md:text-2xl font-bold text-blue-900">Cystolitholapaxy</h3>
              </div>
              <p className="text-sm md:text-base text-gray-600 mb-4">
                Minimally invasive procedure using a cystoscope to:
              </p>
              <ul className="space-y-2 pl-2">
                {[
                  "Locate the bladder stones",
                  "Break stones into small fragments",
                  "Remove fragments through the scope",
                  "No external incisions needed"
                ].map((item, index) => (
                  <li key={index} className="flex items-start">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl md:text-2xl font-bold text-blue-900">Surgical Removal</h3>
              </div>
              <p className="text-sm md:text-base text-gray-600 mb-4">
                For very large stones, we may recommend:
              </p>
              <ul className="space-y-2 pl-2">
                {[
                  "Open cystotomy (small incision)",
      ...
      {/* Treatment Process - Vertical Cards */}
            ...
            {[
              {
                ...
                title: "Diagnosis",
                hindi: "निदान",
                description: "Ultrasound or CT scan to confirm stone presence and size",
              ...
              },
              {
                ...
                title: "Preparation",
                hindi: "तैयारी",
                description: "Urine tests and pre-operative evaluation",
              ...
              },
              {
                ...
                title: "Procedure",
                hindi: "प्रक्रिया",
                description: "Stone removal under anesthesia (30-90 minutes)",
              ...
              },
              {
                ...
                title: "Prevention",
                hindi: "रोकथाम",
                description: "Dietary and lifestyle guidance to prevent recurrence",
            ...
            <div className="md:flex">
              <div className="md:w-1/3 bg-blue-600 p-6 md:p-8 text-white">
                ...
                <p className="text-blue-100">
                  After treatment, we provide guidance to prevent stone recurrence.
                </p>
              </div>
              <div className="md:w-2/3 p-6 md:p-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {[
                    {
                      title: "Hydration",
                      description: "Drink 2.5-3L water daily to keep urine diluted",
                      icon: <Droplet className="text-blue-600" size={20} />
                    },
                    {
                      title: "Diet Changes",
                      description: "Reduce salt, oxalate-rich foods, and animal protein",
                      icon: <Cross className="text-blue-600" size={20} />
                    },
                    {
                      title: "Urination Habits",
                      description: "Don't hold urine for long periods",
                      icon: <Clock className="text-blue-600" size={20} />
                    },
                    {
                      title: "Follow-ups",
                      description: "Regular check-ups to monitor bladder health",
                      icon: <BadgeCheck className="text-blue-600" size={20} />
                    }
                  ].map((item, index) => (
...
export default BladderStonePage;